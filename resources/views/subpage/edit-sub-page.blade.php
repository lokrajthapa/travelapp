...
<div class="container">
    <div class="row">
        <div class="col-md-6 offset-md-3">
                     @if(Session::has('subpage_updated'))
                            <h6 class="alert alert-success"> {{ Session::get('subpage_updated') }}</h6>
                        @endif
                        <div class="card-header"> 
                        <h4> Edit Subpages </h4>
                            <a href="{{ url('/all-sub-pages')}}" class="btn btn-danger float-end"> Back</a>
                        </div>
                        
                        <form action="{{route('subpage.update')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="pagesubheading" value="{{ $subpage->pagesubheading }}" placeholder="Enter page heading">
                            </div>
