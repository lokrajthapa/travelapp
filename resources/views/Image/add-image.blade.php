    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
                     @if(Session::has('image_added'))
                            <h6 class="alert alert-success"> {{ Session::get('image_added') }}</h6>
                        @endif
                        <div class="card-header"> 
                        <h4> Add new Blog </h4>
                            <a href="{{ url('/all-images')}}" class="btn btn-danger float-end"> all images</a>
                        </div>
                        ...
                        @csrf
                            ...
                            <div class="form-group">
                            <label for="textarea">image description</label>
                            <textarea name="text">
